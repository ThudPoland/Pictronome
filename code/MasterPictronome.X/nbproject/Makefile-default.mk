...
SOURCEFILES_QUOTED_IF_SPACED=src/systicktimer.c src/buttons.c src/config.c src/i2c-tools.c src/i2c.c src/interrupts.c src/main.c src/menuentry.c src/oscillator.c src/pwm.c src/softpwm.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/systicktimer.p1 ${OBJECTDIR}/src/buttons.p1 ${OBJECTDIR}/src/config.p1 ${OBJECTDIR}/src/i2c-tools.p1 ${OBJECTDIR}/src/i2c.p1 ${OBJECTDIR}/src/interrupts.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/menuentry.p1 ${OBJECTDIR}/src/oscillator.p1 ${OBJECTDIR}/src/pwm.p1 ${OBJECTDIR}/src/softpwm.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/systicktimer.p1.d ${OBJECTDIR}/src/buttons.p1.d ${OBJECTDIR}/src/config.p1.d ${OBJECTDIR}/src/i2c-tools.p1.d ${OBJECTDIR}/src/i2c.p1.d ${OBJECTDIR}/src/interrupts.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/menuentry.p1.d ${OBJECTDIR}/src/oscillator.p1.d ${OBJECTDIR}/src/pwm.p1.d ${OBJECTDIR}/src/softpwm.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/systicktimer.p1 ${OBJECTDIR}/src/buttons.p1 ${OBJECTDIR}/src/config.p1 ${OBJECTDIR}/src/i2c-tools.p1 ${OBJECTDIR}/src/i2c.p1 ${OBJECTDIR}/src/interrupts.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/menuentry.p1 ${OBJECTDIR}/src/oscillator.p1 ${OBJECTDIR}/src/pwm.p1 ${OBJECTDIR}/src/softpwm.p1

# Source Files
SOURCEFILES=src/systicktimer.c src/buttons.c src/config.c src/i2c-tools.c src/i2c.c src/interrupts.c src/main.c src/menuentry.c src/oscillator.c src/pwm.c src/softpwm.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MasterPictronome.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
