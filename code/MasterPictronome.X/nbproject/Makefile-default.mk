...
# Source Files
SOURCEFILES=src/systicktimer.c src/buttons.c src/config.c src/i2c-tools.c src/i2c.c src/interrupts.c src/main.c src/menuentry.c src/oscillator.c src/pwm.c src/softpwm.c src/buzzer.c src/init.c src/lcdtools.c src/navigation.c src/delegate.c src/ui.c
